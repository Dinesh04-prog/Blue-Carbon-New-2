...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\91830\\Downloads\\Blue Carbon Credits Marketplace (3)\\Backend\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\91830\\Downloads\\Blue Carbon Credits Marketplace (3)\\backend\\prisma\\schema.prisma"
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  },
  ...
  "inlineSchema": "// Prisma schema for PostgreSQL\n// Save as schema.prisma in backend/prisma/\n\ngenerator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\n// Add more models as needed for transactions, credits, etc.\n",
  "inlineSchemaHash": "653dd418e75881e0203ab59aa11bfd418cf4f5679193d928dfc0f6e8080167e1",
  "copyEngine": true
}
