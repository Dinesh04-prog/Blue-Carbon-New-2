      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h1 className="text-5xl md:text-6xl mb-6 leading-tight">
            Welcome to{' '}
            <span className="text-blue-300">BlueMitra</span>
          </h1>
          
          <p className="text-xl md:text-2xl mb-8 text-blue-100 leading-relaxed">
            Your trusted partner in blue carbon credits. Support mangrove restoration, 
            seagrass conservation, and saltmarsh protection while offsetting your carbon footprint 
            through verified projects worldwide.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <Card className="p-6 bg-white/10 backdrop-blur-sm border-white/20 text-center">
              ...
              <p className="text-blue-200">Tonnes CO₂ Offset</p>
            </Card>
